    ...
    <div class="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
      <transition name="slide">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-96 p-6 relative">
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-5 text-center">
            Введите веса
          </h2>

          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Вес нетто</label>
            <input 
              type="number" 
              v-model="netWeight"
              placeholder="Введите вес нетто"
              class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
            />
          </div>
          ...
          <div class="flex justify-end gap-3">
            <button @click="cancel" class="px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-500 transition">
              Отмена
            </button>
          ...
          <button @click="cancel" class="absolute top-3 right-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-xl font-bold transition">
            ×
          </button>
        </div>
      </transition>
