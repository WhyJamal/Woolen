                ...
                <div class="flex-1 min-w-0 overflow-hidden">
                  <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                      ...
                      >
                        Уровень задачи: {{ task.nomenclature.level }} <span v-if="task.stage" class="text-red-500"> - {{ task.stage ? "-" + task.stage : "" }}</span>
                      </span>
                    </div>
            ...
            <div class="bg-gray-200 p-4 rounded-lg">
              <div class="w-full mx-auto space-y-2 px-4">
                ...
                <div class="grid grid-cols-3 bg-white rounded-md shadow">
                  ...
                  <div v-else class="p-3" :class="{ 'border-b pb-2': pressed }">
